    ...
    <div class="row justify-content-center mt-5">
        ...
        <div class="col-md-4">
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="{{ asset('img/avatar.png') }}" height="280px;" width="20px;" alt="Card image cap">
           
                <ul class="list-group list-group-flush">
                  <li class="list-group-item"></li>
                  <li class="list-group-item">{{ Auth::user()->email }}</li>
                  <li class="list-group-item"><a href="{{ route('change.password') }}">Changer Password</a></li>
                </ul>
