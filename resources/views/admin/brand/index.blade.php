                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <td>
                            ...
                            <a href="{{ url('Delete/Brand/'.$brand->id) }}" onclick="return confirm('Are you Shure to Delete')" class="btn btn-danger">Delete</a>
                        </td>
                        </tr>
                        @endforeach
                   </tbody>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('store.brand')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="brand_name" class="form-control @error('brand_name') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Brand Name">
